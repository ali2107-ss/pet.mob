        ...
        builder: (context, setDialogState) => AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                TextField(controller: titleController, decoration: const InputDecoration(labelText: 'Название (напр. Дом)')),
                ...
                TextField(controller: streetController, decoration: const InputDecoration(labelText: 'Улица')),
                TextField(controller: houseController, decoration: const InputDecoration(labelText: 'Дом')),
                TextField(controller: aptController, decoration: const InputDecoration(labelText: 'Квартира')),
              ],
            ),
          ),
          actions: [
